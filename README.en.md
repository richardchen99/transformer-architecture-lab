...
[**Open the lab ↗**](https://richardchen99.github.io/transformer-architecture-lab/) · [Research note · 中文](https://richardchen99.github.io/blog/transformer-architecture-lab-note/) · [简体中文](README.md) · [Quick start](#quick-start)
...
![Framework separating the computed attention core from conceptual Transformer and decoding views](docs/assets/architecture.en.png)

*Original schematic: a numerical attention core surrounded by explanatory architecture views. [Editable SVG](docs/assets/architecture.en.svg) · [Figure provenance · 中文](docs/assets/README.md).*
